...
function Details(data) {
    ...
    clearC = setInterval(() => {
        ...
        dayEI.innerHTML = day + ',';
        dateEI.innerHTML = date + ' ' + name_of_month + ' ' + year;
    }, 1000);
    ...
    if (id >= 200 && id <= 232) {
        imagedesEI.innerHTML =
            `<img src="../assets/images_weather/thunderstorms.svg" alt="Weather Icon">
        <div class="des">
            ${description}
        </div>
        `
        ...
        imagedesEI.innerHTML = `<img src="../assets/images_weather/drizzle.svg" alt="Weather Icon">
        <div class="des">
        ${description}
        </div>`
    }
    else if (id >= 500 && id <= 531) {
        imagedesEI.innerHTML = `<img src="../assets/images_weather/rain.svg" alt="Weather Icon">
        <div class="des">
        ${description}
        </div>`
    }
    else if (id >= 600 && id <= 622) {
        imagedesEI.innerHTML = `<img src="../assets/images_weather/snow.svg" alt="Weather Icon">
        <div class="des">
        ${description}
        </div>`
    }
    else if (id >= 701 && id <= 781) {
        imagedesEI.innerHTML = `<img src="../assets/images_weather/fog-day.svg" alt="Weather Icon">
        <div class="des">
        ${description}
        </div>`
    }
    else if (id == 800) {
        imagedesEI.innerHTML = `<img src="../assets/images_weather/clear-day.svg" alt="Weather Icon">
        <div class="des">
        ${description}
        </div>`
    }
    else {
        imagedesEI.innerHTML = `<img src="../assets/images_weather/cloudy.svg" alt="Weather Icon">
        <div class="des">
        ${description}
        </div>`
    }
